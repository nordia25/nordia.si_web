...
/**
 * Client component for mission section animations
 */
    ...
    const ctx = gsap.context(() => {
      ...
      if (useSimple) {
        ...
        ScrollTrigger.create({
          trigger: title,
          start: "top 80%",
          once: true, // OPTIMIZED: Kill trigger after first activation
          onEnter: () => {
        ...
        // OPTIMIZED: Using batch() reduces ScrollTrigger instances from N to 1
        // More efficient memory usage and scroll event processing
